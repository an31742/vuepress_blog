import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,o as a,a as i}from"./app-DjVV_28a.js";const e={},l=i(`<h1 id="常用数组方法" tabindex="-1"><a class="header-anchor" href="#常用数组方法"><span>常用数组方法</span></a></h1><h3 id="push-pop-shift-unshift" tabindex="-1"><a class="header-anchor" href="#push-pop-shift-unshift"><span>push/pop, shift/unshift</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>【改变原数组,不创建新数组，有返回值】</span></span>

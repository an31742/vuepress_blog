import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as s,o as a,a as e}from"./app-CMxo3qvn.js";const i={},l=e(`<h1 id="原型链类" tabindex="-1"><a class="header-anchor" href="#原型链类"><span>原型链类</span></a></h1><h3 id="创建对象有几种方法" tabindex="-1"><a class="header-anchor" href="#创建对象有几种方法"><span>创建对象有几种方法</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>【字面量，或Object构造函数】</span></span>

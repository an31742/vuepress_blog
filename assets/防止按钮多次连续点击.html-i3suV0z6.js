import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,o as a,a as e}from"./app-1_sQ8TOy.js";const i={},l=e(`<h3 id="_1、使用settimeout" tabindex="-1"><a class="header-anchor" href="#_1、使用settimeout"><span>1、使用setTimeOut</span></a></h3><ul><li>使用两种方法第一种方法是就是在请求之前设置标识，请求之后修改标识。达到连续点击只掉一次请求</li></ul><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>// 用于保存请求状态的标志位</span></span>
